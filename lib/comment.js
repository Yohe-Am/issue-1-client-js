import {
    attachAuthTokenToHeader, generateQueryParams,
    makeRequest
} from "./utilites";
 ...
 * Represents standard comments users can attach to a post or another comment.
 * 
 * @property {number} id
 * @property {string} commenter
 * @property {number} originPost
 * @property {string} content
 * @property {number} [replyTo] - either and id of another comment or -1 if it's a reply to original post.
